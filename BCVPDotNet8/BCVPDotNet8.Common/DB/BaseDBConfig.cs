...
namespace BCVPDotNet8.Common.DB
{
    public class BaseDBConfig
    {
        ...
        /// 所有库配置
        /// </summary>
        public static  List<ConnectionConfig> AllConfigs = new();
        ...
        */
        public static (List<MutiDBOperate> allDbs, List<MutiDBOperate> slaveDbs) MutiConnectionString => MutiIniConn();

        public static (List<MutiDBOperate>, List<MutiDBOperate>) MutiIniConn()
        {
